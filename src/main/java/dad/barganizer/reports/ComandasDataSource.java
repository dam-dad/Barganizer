...
/**
 * Esta clase nos ayudará a representar la datasource que se le proporcionará al
 * formulario. Implementa una interfaz JRDataSource en la cual definimos la
 * forma en la que se recorre una colección de elementos y la forma en la que se
 * asignan los valores a los campos del formulario
 **/
public class ComandasDataSource implements JRDataSource {
	...
	/**
	 * Este método nos ayudará a tratar el campo leído en el fichero jasper y
	 * proporcionar el valor correspondiente del elemento encontrado en la lista
	 **/
	@Override
